...
tags = {
  names  = { "im", "www", "0011", "0100", "0101", "0110", "0111", "notes", "spotify" },
  layout = { layouts[5], layouts[5], layouts[1], layouts[1], layouts[1],
             layouts[1], layouts[1], layouts[1], layouts[5]
}}
for s = 1, screen.count() do
...
vicious.register(batterywidget, vicious.widgets.bat, "Bat: <span color='" .. hlcolor .. "'>$1$2</span> % | ", 67, "BAT1")
